        ...
        >
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-4 max-w-xl text-pretty text-base leading-relaxed text-white/70 sm:text-lg">
              Cuéntanos tu idea y te mostramos cómo un sitio web puede
              impulsar tus ventas.
            </p>

            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <a
                href="https://wa.me/573214575060?text=Hola%20Nexora%20Studio,%20quiero%20una%20asesor%C3%ADa%20gratuita"
                target="_blank"
              ...
              {/*
<a href="mailto:contacto@nexorastudio.co">
  Correo
</a>
*/}
            </div>
